...
app = Flask(__name__, static_url_path='', static_folder=os.path.join(os.getcwd(), '/react-frontend/build/static'), template_folder=os.path.join(os.getcwd(), '/react-frontend/build/static'))
